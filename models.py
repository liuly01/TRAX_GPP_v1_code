...
class LSTM(nn.Module):
    """
    Basic single-direction LSTM block that returns full sequence and last hidden state.
    """
...
class LSTMMain(nn.Module):
    """
    Wrapper model for sequence-to-one (or sequence-to-multi-step) prediction.
    Uses LSTM + Dropout + Linear on the last time step.
    """
